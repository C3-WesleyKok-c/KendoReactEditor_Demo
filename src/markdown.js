export const markdown = `The KendoReact Editor allows your users to edit markdown in a familiar, user-friendly way.
...
* Images ![KendoReact Editor Markdown Smile image](https://prosemirror.net/img/smiley.png "Smile")
